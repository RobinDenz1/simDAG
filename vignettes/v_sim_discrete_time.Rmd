...
t0_dag <- empty_dag() +
  ...
  node("death", type="binomial", parents=c("age", "sex"), betas=c(0.15, 0.25),
       intercept=-10)
```
...
t0_dag <- empty_dag() +
  node("age", type="rnorm", mean=30, sd=5) +
  node("sex", type="rbernoulli", p=0.5) +
  node("cve", type="binomial", parents=c("age", "sex"), betas=c(0.15, 0.25),
       intercept=-15)
```
