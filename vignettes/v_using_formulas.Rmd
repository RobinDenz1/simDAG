...
Formulas should always start with a `~` sign and have nothing else on the left hand side. All parts of the formula should be connected by `+` signs, never `-` signs. The name of the respective variable should always go first, followed by a `*` sign and the associated coefficient. They may also be supplied as strings and will produce the same output.
