...
#> 2:     1     0  0.968 -2.368  0.101 -0.040     0  0.405        0
#> 3:     0     0  0.125  2.012  0.662  0.694     1  0.605        1
#> 4:     0     1 -0.142 -2.610 -0.826  0.588     1  1.093        1
#> 5:     0     0 -0.273  0.632  1.462  0.007     1  0.576        1
#> 6:     1     1 -0.198  0.379  0.693  2.416     1  0.124        1
```
...
`data.table` 1.18.2.1 package, the `survival` 3.8.3 package, the
`igraph` 2.2.1 package, the `ggplot2` 4.0.1 package and the `simDAG`
0.5.0.9000 package. `R` itself and all packages used are available from
